...
export default function Footer() {
  const { t } = useLanguage()
  return (
    <footer className="bg-carbon-900 text-hueso-100/70 py-12 border-t border-hueso-100/10">
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex flex-wrap justify-between items-center gap-6">
          <div className="font-titulo text-lg text-hueso-100">ALTO ANDINO</div>
        ...
        <div className="mt-8 pt-5 border-t border-hueso-100/10 text-xs text-center text-hueso-100/45">
